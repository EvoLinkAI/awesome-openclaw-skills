🌐 [English](README.md) | [Español](README.es.md) | [Português](README.pt.md) | **日本語** | [한국어](README.ko.md) | [Deutsch](README.de.md) | [Français](README.fr.md) | [Türkçe](README.tr.md) | [繁體中文](README.zh-TW.md) | [简体中文](README.zh-CN.md)
...
1. [evolink.ai](https://evolink.ai/signup?utm_source=github&utm_medium=readme&utm_campaign=awesome-openclaw-skills) で登録
...
スキルにはコマンドラインで直接使用できる `skills/seedance2-video-gen/scripts/seedance-gen.sh` が含まれています：

```bash
# テキストからビデオ
./skills/seedance2-video-gen/scripts/seedance-gen.sh "夜明けの穏やかな山の風景" --duration 5 --quality 720p

# 画像からビデオ（最初のフレームからアニメーション）
./skills/seedance2-video-gen/scripts/seedance-gen.sh "穏やかな海の波" --image "https://example.com/beach.jpg" --duration 8 --quality 720p

# リファレンスからビデオ（画像でビデオクリップを編集）
./skills/seedance2-video-gen/scripts/seedance-gen.sh "アイテムを画像1の製品に置き換え" --image "https://example.com/product.jpg" --video "https://example.com/clip.mp4" --duration 5 --quality 720p

# ソーシャルメディア用縦型
./skills/seedance2-video-gen/scripts/seedance-gen.sh "踊る粒子" --aspect-ratio 9:16 --duration 4 --quality 720p

# 音声なし
./skills/seedance2-video-gen/scripts/seedance-gen.sh "抽象芸術アニメーション" --duration 6 --quality 720p --no-audio
```

### API パラメータ

完全な API ドキュメントは [skills/seedance2-video-gen/references/api-params.md](skills/seedance2-video-gen/references/api-params.md) を参照してください。
...
.
├── README.md                    # このファイル
├── skills/seedance2-video-gen/SKILL.md                     # OpenClaw スキル定義
├── _meta.json                   # スキルメタデータ
