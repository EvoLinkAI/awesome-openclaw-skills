...
const SLUG = "google-sheets-assistant";
const VERSION = "1.0.2";
...
function main() {
  console.log(`\n  Google Sheets Assistant — OpenClaw Skill Installer v${VERSION}`);
  console.log(`  Powered by evolink.ai + Maton\n`);
  ...
  console.log("  1. export MATON_API_KEY=\"your-key\"    (get at maton.ai/settings)");
  console.log("  2. bash scripts/sheets.sh connection create");
  console.log("  3. (Optional) export EVOLINK_API_KEY=\"your-key\"  (for AI features)");
  console.log("  4. bash scripts/sheets.sh help");
  console.log("");
}
