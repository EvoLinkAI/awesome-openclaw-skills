...
function main() {
  console.log(`\n  Slack Assistant — OpenClaw Skill Installer v${VERSION}`);
  ...
  console.log('  2. Save bot token: echo \'{"bot_token": "xoxb-..."}\' > ~/.slack-skill/credentials.json');
  console.log("  3. (Optional) export EVOLINK_API_KEY=\"your-key-here\"");
  console.log("");
}
